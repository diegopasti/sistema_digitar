...
class Session(models.Model):
    ...
    internal_ip = models.GenericIPAddressField("IP Interno:", null=True, blank=True,error_messages=ERRORS_MESSAGES)
    external_ip = models.GenericIPAddressField("IP Externo:", null=True, blank=True, error_messages=ERRORS_MESSAGES)
    country_name = models.CharField("País", max_length=50, null=True, blank=True, error_messages=ERRORS_MESSAGES)
    country_code = models.CharField("Sigla do País", max_length=2, null=True, blank=True, error_messages=ERRORS_MESSAGES)
    region_code  = models.CharField("Sigla do Estado", max_length=2, null=True, blank=True, error_messages=ERRORS_MESSAGES)
    region_name  = models.CharField("Estado", max_length=60, null=True, blank=True, error_messages=ERRORS_MESSAGES)
    city         = models.CharField("Cidade", max_length=100, null=True, blank=True, error_messages=ERRORS_MESSAGES)
    zip_code     = models.CharField("Código Postal", max_length=10, null=True, blank=True, error_messages=ERRORS_MESSAGES)
    time_zone    = models.CharField("Fuzo Horário", max_length=30, null=True, blank=True, error_messages=ERRORS_MESSAGES)
    latitude     = models.CharField("Latitude", max_length=20, null=True, blank=True, error_messages=ERRORS_MESSAGES)
    longitude    = models.CharField("Longitude", max_length=20, null=True, blank=True, error_messages=ERRORS_MESSAGES)
