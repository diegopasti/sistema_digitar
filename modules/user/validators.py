...
from modules.nucleo.validators import is_empty, contain_alpha, contain_numbers, contain_minimal_size
...
def password_format_validator(value):
    if is_empty(value) or not contain_minimal_size(value,6):
