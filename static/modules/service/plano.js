...
function selecionar_checkbox(campo) {
    var registro_id = "#"+campo;
    registro_id = registro_id.replace("label_servico_","checkbox_servico_");

    if($(registro_id).prop('checked') == true){
        $(registro_id).prop('checked', false);
        //alert("desmarquei");
    }
    else{
        $(registro_id).prop('checked', true);
        //alert("marquei");
    }
}